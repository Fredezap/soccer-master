...
const HeroHomeNoTournament = () => {
  return (
    // <div className="hero custom-hero" style={{ backgroundImage: `url(${futsalForHerBackground2})` }}> // to get back to the firs idea
    <div className="hero custom-hero hero-custom-img">
