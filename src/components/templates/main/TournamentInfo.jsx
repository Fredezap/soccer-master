    ...
    <div className="tournament-info-container">
      ...
      <div>
        ...
        <ul className="list-info">
          ...
          <li>Wir empfehlen, pro Team neun bis elf Spielerinnen mitzunehmen (zwei Blöcke)</li>
          <li>Die Siegerinnen-Teams erhalten attraktive Preise</li>
          <li>Es werden verschiedene Skill-Competitions stattfinden, um die Wartezeit zwischen den Spielen zu verkürzen</li>
          <li>Anmeldeschluss: 16.11.25</li>
          <li>Anmeldegebühr: 120 CHF (Zahlungsfrist innert 14 Tagen nach erfolgter Anmeldung, keine Rückerstattung bei einer Abmeldungen nach dem 16.11.25)</li>
        </ul>
      </div>
    </div>
  )
