    ...
    <div className="container site-section">
      ...
      <div className="row">
        <div className="col-lg-4 mb-4">
          <div className="custom-media d-block">
            <div className="img mb-4">
              <a href="single.html"><img src="images/img_1.jpg" alt="Image" className="img-fluid"></img></a>
            </div>
            <div className="text">
        ...
        <div className="col-lg-4 mb-4">
          <div className="custom-media d-block">
            <div className="img mb-4">
              <a href="single.html"><img src="images/img_3.jpg" alt="Image" className="img-fluid"></img></a>
            </div>
            <div className="text">
              <span className="meta">May 20, 2020</span>
              <h3 className="mb-4"><a href="#">Romolu to stay at Real Nadrid?</a></h3>
